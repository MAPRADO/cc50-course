...
// Registrar preferência(rank) se o voto for válido
bool vote(int voter, int rank, string name)
{
    // TO DO
    for (int i = 0; i < candidate_count; i++)
...
// Tabulação dos votos para os candidatos não eliminados
void tabulate(void)
{
    // TO DO
    for (int i = 0; i < voter_count; i++)
...
// Retornar verdadeiro se a eleição estiver empatada entre todos os candidatos, falso caso contrário
bool is_tie(int min)
{
    // TO DO
    int eliminate = 0;
